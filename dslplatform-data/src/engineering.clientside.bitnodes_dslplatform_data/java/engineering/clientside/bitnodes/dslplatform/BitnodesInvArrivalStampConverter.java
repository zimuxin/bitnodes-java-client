...
public abstract class BitnodesInvArrivalStampConverter extends DslPlatformBaseConverter {
  ...
  public static final JsonReader.ReadObject<BitnodesInvArrivalStamp> JSON_READER = reader -> {
    ...
    return new DslPlatformBitnodesInvArrivalStamp(nodeIpPort, timestamp);
  };
}
