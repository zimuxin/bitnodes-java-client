...
public class BitnodesCoderTest {
  ...
  public void equalsContract() {
    EqualsVerifier.forClass(DslJsonBitnodesNode.class).verify();
    EqualsVerifier.forClass(DslJsonBitnodesInvArrivalStamp.class)
        .suppress(Warning.NULL_FIELDS).verify();
    EqualsVerifier.forClass(DslJsonBitnodesInvArrivalStats.class)
    ...
    EqualsVerifier.forClass(DslJsonBitnodesNodeLatency.class)
        .suppress(Warning.NULL_FIELDS, Warning.NONFINAL_FIELDS).verify();
    EqualsVerifier.forClass(DslJsonBitnodesNodes.class)
        .suppress(Warning.NULL_FIELDS).verify();
    EqualsVerifier.forClass(DslJsonBitnodesNodeStatus.class)
        .suppress(Warning.NULL_FIELDS, Warning.NONFINAL_FIELDS).verify();
    EqualsVerifier.forClass(DslJsonBitnodesPostResponse.class)
        .suppress(Warning.NONFINAL_FIELDS).verify();
