...
public abstract class BitnodeNodeConverter extends DslJsonBaseConverter {
  ...
  public static final JsonReader.ReadObject<BitnodesNode> JSON_READER = reader -> {
    ...
    return new DslJsonBitnodesNode(protocolVersion, userAgent, connectedSince, services,
